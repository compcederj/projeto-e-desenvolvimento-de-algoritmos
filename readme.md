# Projeto e Desenvolvimento de Algorítmos
Repositório de provas antigas da Disciplina **Projeto e Desenvolvimento de Algorítmos** do curso de **Tecnologia em Sistemas de Computaćao** da **UFF** ministrado através do **CEDERJ**.
...
`git clone https://github.com/compcederj/projeto-e-desenvolvimento-de-algoritmos.git`
...
`git clone git@github.com:compcederj/projeto-e-desenvolvimento-de-algoritmos.git`
...
# Projeto e Desenvolvimento de Algorítmos
Repositório de provas antingas da Disciplina **Projeto e Desenvolvimento de Algorítmos** do curso de **Tecnologia em Sistemas de Computaçao** da **UFF** ministrado através do **CEDERJ**.
